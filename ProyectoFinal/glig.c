...
void dibujaPersona() {
	...
	float alto_cuerpo = 1.0f;
	float ancho_cuerpo = 0.6f;
	float largo_cuerpo = 0.25f;
	float alto_brazo = 0.77f;
	float ancho_brazo = 0.25f;
	float largo_brazo = 0.25f;
	float radio_cabeza = 0.27f;
	float alto_pierna = 1.1f;
	float ancho_pierna = 0.25f;
	float largo_pierna = 0.25f;
